  ...
  return (
    <div className="border-b border-brand-border">
      ...
      >
        ...
        {open ? <ChevronUp size={16} className="text-brand-blue flex-shrink-0" /> : <ChevronDown size={16} className="text-brand-muted flex-shrink-0" />}
      </button>
      {open && (
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/" className="text-brand-blue text-sm font-semibold hover:underline">{t('servicePage.backHome')}</Link>
        </div>
      </div>
    )
  }
  ...
  return (
    <>
      ...
      <section className="bg-brand-black pt-40 pb-32 px-6 relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-bl from-brand-blue/10 to-transparent pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <h1 className="text-5xl sm:text-7xl lg:text-8xl font-black text-brand-blue uppercase leading-[0.9] tracking-tighter mb-8 max-w-4xl">
            {service.headline}
          </h1>
          ...
          <a href="#contact" className="group inline-flex items-center gap-3 text-brand-blue text-[13px] font-bold tracking-widest uppercase hover:text-brand-white transition-colors">
            <span className="w-8 h-8 border border-brand-blue group-hover:border-brand-white flex items-center justify-center transition-colors">
      ...
      <section className="bg-brand-white py-32 px-6 border-b border-brand-border">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-32">
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-black text-brand-blue uppercase leading-[0.95] tracking-tight">
              ...
              return (
                <div key={cap.title} className="flex flex-col sm:flex-row gap-6 items-start">
                  <div className="flex-shrink-0 mt-1">
                    <Icon size={28} strokeWidth={1.5} className="text-brand-blue" />
                  </div>
                  <div>
      ...
      <section className="bg-brand-black py-32 px-6 relative">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-3xl sm:text-5xl font-black text-brand-white uppercase leading-tight tracking-tight mb-20 max-w-3xl">
            ...
            <span className="text-brand-blue">{t(`services.${service.id}.title`, { defaultValue: service.id }).toUpperCase()} {t('servicePage.solutions')}</span>
          </h2>
            ...
            {service.subServices.map((sub) => (
              <div key={sub.number} className="flex flex-col md:flex-row md:items-center gap-4 md:gap-12 py-8 border-b border-white/10 group hover:bg-white/[0.02] transition-colors -mx-6 px-6">
                <div className="w-48 flex-shrink-0">
                  <h3 className="text-base font-black text-brand-white uppercase tracking-tight group-hover:text-brand-blue transition-colors">
                    {sub.category}
                  </h3>
                </div>
      ...
      <section className="bg-[#111] py-24 px-6 border-y border-white/5 relative overflow-hidden">
        ...
        <div className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/4 w-96 h-96 bg-brand-blue/20 blur-[100px] rounded-full pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12 relative z-10">
          <div className="max-w-xl">
            <h2 className="text-2xl sm:text-3xl font-black text-brand-white uppercase tracking-tight leading-snug mb-2">
              ...
              <span className="text-brand-blue">{t('servicePage.banner.title3')}</span>
            </h2>
          </div>
          <div className="flex-shrink-0">
            <a href="#contact" className="inline-block px-8 py-4 bg-brand-blue text-brand-white text-[13px] font-black uppercase tracking-widest hover:bg-brand-blue-hover transition-colors">
      ...
      <section className="bg-brand-white py-32 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-4xl sm:text-5xl font-black text-brand-black uppercase tracking-tight mb-20">
            ...
            <span className="text-brand-blue">{t('servicePage.processSub')}</span>
          </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8">
            ...
            <div className="lg:col-span-4 flex flex-col divide-y divide-brand-border border-t border-brand-border">
              {service.process.map((step) => (
                ...
                >
                  <span className={`text-[11px] font-bold tracking-widest uppercase transition-colors ${activeStep === step.number ? 'text-brand-blue' : ''}`}>
                    {step.number}.
                  </span>
            ...
            <div className="lg:col-span-8 lg:pl-12 flex flex-col justify-center">
              <h3 className="text-3xl font-black text-brand-blue uppercase tracking-tight mb-6 leading-tight max-w-2xl">
